...
interface CircularProgressProps extends React.HTMLAttributes<HTMLDivElement> {
    ...
    max?: number
    /** `true` shows `value`. Pass a node to render your own center content. */
...
function resolveLabel(value: number, label?: boolean | React.ReactNode) {
    if (label === true) {
        return value
    }
...
const CircularProgress = ({
    ...
    const labelContent = resolveLabel(value, label)
